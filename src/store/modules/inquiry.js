import { getPatientInfo, exitAccount, getFirstRecord,getFirstRecor2d, getdrugadd, getMyOrders, getOrdersInfo, getDoctorsadvice, endInquiry, getIntegralInfo, getQuery } from '@/api/inquiry'
