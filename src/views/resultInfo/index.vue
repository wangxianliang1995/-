  ...
  <div class="app-container">
    ...
    <el-form ref="form" :model="form" label-width="120px">
      ...
      <el-row>
        <el-col>
          <el-form-item>
            <!-- <el-input v-model="form.diagnoseInfo" type="textarea" autosize="true" readonly="true"></el-input> -->
            {{form.diagnoseInfo}}
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row>
        <el-col>
          <el-form-item >
               <div class="border" style="width:220px;" width="200" hight="100">
  ...
  created() {
    this.$store
      ...
      .then(response => {
        ...
        this.form.diagnoseInfo = response.body.diagnoseInfo
